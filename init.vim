...
set cursorcolumn " Resalta el cursor de forma vertical
...
set spelllang=en,de,es " Corrector Ortografico
set ignorecase " Ignorar Mayusculas al buscar palabras
set smartcase " No ignorar Mayusculas si la palabra contiene Mayusculas
